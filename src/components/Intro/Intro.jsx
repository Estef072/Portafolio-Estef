...
import separador from '../../assetes/separador.png'
const Intro = () => {
  return (
    <div className='intro'>
      <div className='i-l'>
      <div clasName ='parteI-wrapper'>
          ...
          <div className='i-desc'>
                Soy Estefania, una estudiante de ingenieria en 
                Ciencias de la computacion en la Universidad 
                del Valle de Guatemala.Actualmente estoy concluyendo 
                mi quinto semestre, con aproximadamente 30 cursos 
                aprobados; También sé programar en distintos 
                lenguajes, tales como: python, kotlin,HTML,
                Javascript,Java,C,C++
          </div>
            <form method="get" action="https://drive.google.com/file/d/17h-j8SeI-tUEYTo-O53OquBY-nXJcHuT/view?usp=sharing">
                  <button href="http://3.135.147.195:3008/index.html" className='button'> Ver más     
                  </button>
            </form>
