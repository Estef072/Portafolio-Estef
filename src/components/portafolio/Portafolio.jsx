  ...
  return (
    <div className="portafolio">
      ...
      <div className="texto-por">
        <h1 className="pl-title"> Estefanias creative portfolio</h1>
        <p className="pl-desc"> Este es mi portafolio creativo, el cual muestra algunos de los datos desarrollados durante todo el semestre</p>
      </div>
